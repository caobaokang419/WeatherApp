...
package com.gary.weatherdemo.firebase.invite;
 ...
 * displays as a Dialog over the InviteMainActivity and does not cover the full screen.
 */
public class DeepLinkActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fb_invite_deep_link);
