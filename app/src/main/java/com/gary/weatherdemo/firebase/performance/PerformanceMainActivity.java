package com.gary.weatherdemo.firebase.performance;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                File contentFile = new File(PerformanceMainActivity.this.getFilesDir(), CONTENT_FILE);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    mTrace.stop();
                    PerformanceMainActivity.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(PerformanceMainActivity.this, "Trace completed",
                ...
                .addOnCompleteListener(new OnCompleteListener<String>() {
                    ...
                    public void onComplete(@NonNull Task<String> task) {
                        if (!task.isSuccessful()) {
                            ...
                            Toast.makeText(
                                    PerformanceMainActivity.this, getString(R.string.text_read_error), Toast.LENGTH_LONG)
                                    .show();
                            return;
                        }
