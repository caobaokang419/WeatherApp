...
package com.gary.weatherdemo.firebase.appindexing;
...
public class AppIndexingMainActivity extends AppCompatActivity {

    private static final String TAG = AppIndexingMainActivity.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fb_perf_main);
        ...
        addStickersBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startService(new Intent(AppIndexingMainActivity.this, AppIndexingService.class));
            }
        });
        ...
        clearStickersBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AppIndexingUtil.clearStickers(AppIndexingMainActivity.this, firebaseAppIndex);
            }
        });
        // [END_EXCLUDE]
    ...
    public void onStart() {
        ...
        // scheduled
        task.addOnSuccessListener(AppIndexingMainActivity.this, new OnSuccessListener<Void>() {
            @Override
        ...
        task.addOnFailureListener(AppIndexingMainActivity.this, new OnFailureListener() {
            @Override
        ...
        actionTask.addOnSuccessListener(AppIndexingMainActivity.this, new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void aVoid) {
        ...
        actionTask.addOnFailureListener(AppIndexingMainActivity.this, new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception exception) {
